...
public class XMLUtil implements Serial{
     ...
     * The XML representation is based on the WOX standard.
    ...
    /**
     * This method displays the XML representation of the JDOM Element (object) passed
     * as parameter. The XML representation is based on the WOX standard.
    ...
    /**
     * This method takes a JDOM Element and returns its string
     * representation in XML ready to be presented in a browser
     * The method replaces the characters '<' and '>' by '&lt'
     * and '&gt' respectively.
    ...
    /**
     * This method converts an XML file into a JDOM Element. The path of the
     * XML file must be provided.
    ...
    /**
     * This method creates an XML file, and puts the JDOM Element as
     * its contents.
    ...
    /**
     * It generates a random number and returns it as string. This is
     * normally used to be concatenated with the XML filename.
    ...
    // Carlos Jaimez
    //02 March 2005
    /* public static String convertXmlToString(Element element) throws Exception
    {
    XMLOutputter fmt = new XMLOutputter();
    ...
    /*public static Document convertXmlStringToDoc(String xmldoc) throws IOException
    {
    Document doc=new Document();
    ByteArrayInputStream bais=new ByteArrayInputStream(xmldoc.getBytes());
    InputStream ins=bais;
    BufferedReader reader=null;
    try
    {
    reader = new BufferedReader(new InputStreamReader(ins,"ISO-8859-1"));
    }
